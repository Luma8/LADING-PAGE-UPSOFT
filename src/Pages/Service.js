                        ...
                        <div className="section0">
                            <Animator animation={batch(Sticky(), Fade(), MoveOut(0, 200))}>
                                <div className="container">
                                    ...
                                    <img className='Imagecenter' src={DeveloperService} />
                                </div>
                            </Animator>
                        </div>
                    </ScrollPage>
                            ...
                            <Animator animation={batch(Fade(), MoveOut(0, 200))}>
                                <div className='container'>
                                    ...
                                    <div className='container space-between mt-5'>
                                        ...
                                        <img className='imgPrograming' src={ECommerce} />
                                    </div>
                                </div>
                            </Animator>
                        </div>
                            ...
                            <Animator animation={batch(Fade(), MoveOut(0, 200))}>
                                <div className='container'>
                                    ...
                                    <div className='container space-between mt-5'>
                                        ...
                                        <img className='imgPrograming' src={Methods} />
                                    </div>
                                </div>
                            </Animator>
                        </div>
                            ...
                            <Animator animation={batch(Fade(), MoveOut(0, 200))}>
                                <div className='container'>
                                    ...
                                    <div className='container space-between mt-5'>
                                        ...
                                        <img className='imgPrograming' src={Dashboard} />
                                    </div>
                                </div>
                            </Animator>
                        </div>
